    ...
    <>
      <section className="max-w-6xl mx-auto flex flex-col justify-center items-center">
        ...
        <div className="w-full md:w-[50%] mt-6 px-3">
          ...
          <button
            type="submit"
            className="bg-blue-600 w-full text-white uppercase px-7 py-3 text-sm font-medium rounded shadow-md hover:bg-blue-700 active:bg-blue-800 hover:shadow-lg transition duration-150 ease-in-out"
          >
            <Link
              to="/create-listing"
